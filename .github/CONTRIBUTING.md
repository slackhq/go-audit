...
Before opening a new issue, please consider:
  ...
  - Trying out the examples [provided in this repository](https://github.com/slackhq/go-audit#getting-set-up).
  ...
  - Finally, [**open an issue**](https://github.com/slackhq/go-audit/issues/new) to report a bug, ask for help or suggest a feature. The more information you give, the better people can help you.
...
- [Fork the repository](https://github.com/slackhq/go-audit) and make sure to work on a branch up to date with origin master.
- Do your thing!
...
- Read and agree to our [Contributor License Agreement (CLA)](https://cla-assistant.io/slackhq/go-audit). _We cannot accept your PR without your agreement to our CLA_.
